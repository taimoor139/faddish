                    ...
                    <div class="card">
                        <div class="card-body">
                            @if(!empty($products->is_cover))
                                <img alt="Image placeholder" src="{{$logo.$products->is_cover}}" class="img-fluid rounded prd_img_lg">
                                    ...
                                    <div class="col-4">
                                        <div class="p-3 border rounded">
                                            @if(!empty($products_image[$key]->product_images))
                                                <img alt="Image placeholder" src="{{$p_logo.$products_image[$key]->product_images}}" class="img-fluid prd_img_sm">
{{-- 

        ...
        <div class="navbar-hader">
            <a href="" class="navbar-brand">
                <span class="logo-box grey-bg">
                    ...
                    <img src="{{$s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')}}" class="nav_tab_img" style="margin:15px 9px ">
            ...
            <ul class="navigation navigation main pro_category">
                @foreach($categories as $key=>$category)
                    <li class="nav-item">
                        ...
                        <a data-href="{{$loop->iteration}}{!!str_replace(' ','_',$category)!!}" class="{{($key==0)?'active':''}} custom-list-group-item text-link grey-text productTab">
                            {{__($category)}}
                        </a>
                                    ...
                                    @if(count($shippings) != 0)
                                        <div class="card">
                                            <div class="form-group">
                                                <h4 class="card-header card-title">{{__('Shipping Location')}}</h4>
                                            </div>
                                            <div class="card-body">
                                            ...
                                            @if($product['variant_id'] != 0 )
                                                ...
                                                <div class="checkout-items">
                                                    <div class="customer-images">
                                                        ...
                                                        <img src="{{ !empty($product['cover_image']) ? $logo . '/' . $product['cover_image'] : $logo . '/avatar.png' }}" /></span>
      ...
      <div class="modal-content ">
        ...
        <div class="modal-body row">
            <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                ...
                <a data-url="{{route('customer.login',$store->slug)}}" data-ajax-popup="true" data-title="{{__('Login')}}"  data-toggle="modal" class="btn btn-secondary btn-light rounded-pill" id="loginBtn">
                    {{__('Countinue to sign in')}}
                </a>
            </div>
            <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0 asGuest">
                <a href="#footer" class="btn btn-primary ms-2 rounded-pill">{{__('Continue as guest')}}</a>
            </div>
        </div>
      </div>
    </div>

...
@foreach($products as $key => $items)
    <div class="collection-lists collection-items {{ ($loop->iteration != 1) ? 'd-none' : ''  }} {{$loop->iteration}}{!!str_replace(' ', '_', ($key))!!} product_tableese">
                    ...
                    <div class="collection-img">
                        <a href="#" data-size="lg" data-url="{{ route('store.product.product_view',[$store->slug,$product->id]) }}" data-title="{{$product->name}}" data-ajax-popup="true">
                            {{-- @if(!empty($product->is_cover))
                                <img alt="Image placeholder" src="{{asset(Storage::url('uploads/is_cover_image/'.$product->is_cover))}}" width="70px" height="65px">
                            @else
                                <img alt="Image placeholder" src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" width="70px" height="65px">
                            @endif --}}
                        </a>
                    </div>

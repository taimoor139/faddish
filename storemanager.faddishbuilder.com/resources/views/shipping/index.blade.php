                                                    ...
                                                    <td class="Action">
                                                        <span>
                                                            <div class="action-btn btn-info ms-2">
                                                                <a href="#" data-size="md" data-url="{{ route('location.edit', $location->id) }}" data-ajax-popup="true" data-title="{{__('Edit type')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                            </div>

...
@section('action-btn')
    <div class="row  m-1">
        ...
        <div class="col-auto pe-0">
            <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create ')}}" data-size="lg" data-ajax-popup="true" data-title="{{__('Create New Store')}}" data-url="{{ route('store-resource.create') }}">
                                        ...
                                        <td class="Action">
                                            <span>
                                                <div class="action-btn btn-info ms-2">
                                                    <a href="#" data-size="lg" data-url="{{ route('store-resource.edit',$usr->id) }}" data-ajax-popup="true" data-title="{{__('Edit Store')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                                ...
                                                title="{{ __('Delete') }}"> <i class="ti ti-trash"></i></span></a>
                                                    {!! Form::close() !!}
                                                </div>

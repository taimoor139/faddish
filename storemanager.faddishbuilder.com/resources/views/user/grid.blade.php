                ...
                <div class="card">
                        ...
                        <div class="card-header-right">
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    ...
                                    <a href="#" data-size="md" data-url="{{route('user.reset',$user->id)}}" data-ajax-popup="true" data-title="{{__('Reset Password')}}"  class="dropdown-item"><i
                                            class="ti ti-key"></i>
                                    ...
                                    {!! Form::open(['method' => 'DELETE', 'route' => ['user.destroy', $user->id],'id'=>'delete-form-'. $user->id]) !!}
                                        <a href="#!" class="mx-3   btn-sm d-inline-flex align-items-center show_confirm">
                                           <i class="ti ti-trash"></i>@if($user->delete_status == 0)    <span class="ms-1">{{__('Delete')}}</span> @else {{__('Restore')}}@endif</a>
                                    {!! Form::close() !!}
                    ...
                    <div class="card-body text-center">
                        <div class="avatar-parent-child">
                            <img alt="" src="{{ !empty($user->avatar) ? $profile . '/' . $user->avatar : $profile . '/avatar.png' }}"class="img-fluid rounded-circle card-avatar">
                        </div>

...
@section('action-btn')
    ...
    <div class="row  m-1">
        ...
        <div class="col-auto pe-0">
               <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Product Category')}}" data-size="lg" data-ajax-popup="true" data-title="{{__('Add Coupon')}}" data-url="{{route('product-coupon.create')}}">

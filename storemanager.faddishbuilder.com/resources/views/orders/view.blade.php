...
@section('action-btn')
    <div class="row  m-1">
        <div class="col-auto pe-0 ">
            <a href="#" id="{{ env('APP_URL')  . ''.$store->slug . '/order/' . $order_id }}" class="btn btn-sm btn-primary btn-icon mb-1"  onclick="copyToClipboard(this)" title="Copy link" data-bs-toggle="tooltip" data-original-title="{{__('Click to copy')}}"><i class="ti ti-link text-white"></i></a>
       </div>
        <div class="col-auto pe-0">
                                ...
                                <div class="card-body pt-0">
                                    <address class="mb-0 text-sm">
                                        <dl class="row mt-4 align-items-center">
                                            ...
                                            <dt class="col-sm-4 h6 text-sm">{{ __('Shipping Address') }}</dt>
                                            ...
                                            <dt class="col-sm-4 h6 text-sm">{{__('Billing Address')}}</dt>
                                        ...
                                        <tr>
                                            <td colspan="4"><b>
                                                ...
                                                @if(!empty($user_details->special_instruct))
                                                    <dd class="p-2 d-inline"> {{$user_details->special_instruct}}</dd>
                                                @endif
                                            </td>
                                        </tr>
                                    </tfoot>

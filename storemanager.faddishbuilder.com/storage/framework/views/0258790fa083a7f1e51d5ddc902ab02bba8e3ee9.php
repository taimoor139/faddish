...
<div>
    ...
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row collection-items <?php echo e(($loop->iteration != 1) ? 'd-none' : ''); ?> <?php echo e($loop->iteration); ?><?php echo str_replace(' ','_',$key); ?> product_tableese">
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-sm-6 col-md-6 col-xl-3 product_item" data-name="<?php echo e($product->name); ?>">
                    <div class="product-card">
                            <a href="#" data-size="lg" data-url="<?php echo e($flag != 'my_orders' ? route('store.product.product_view',[$store->slug,$product->id]):route('store.product.product_order_view',[$product->id,Auth::guard('customers')->user()->id,$store->slug])); ?>" data-title="<?php echo e($product->name); ?>" data-ajax-popup="true" class="product_details_icon float-right"><i class="fas fa-eye product_details_active text_color"></i></a>
                        <div class="product-image">
                            <a href="#" data-size="lg" data-url="<?php echo e($flag != 'my_orders' ? route('store.product.product_view',[$store->slug,$product->id]):route('store.product.product_order_view',[$product->id,Auth::guard('customers')->user()->id,$store->slug])); ?>" data-title="<?php echo e($product->name); ?>" data-ajax-popup="true">
...
<?php endif; ?>
<?php /**PATH /home/faddishbuilder/public_html/storemanager.faddishbuilder.com/resources/views/storefront/grid.blade.php ENDPATH**/ ?>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        ...
                                        <tr>
                                            <td style="width:300px;">
                                                <img alt="" height="auto" src="<?php echo e(asset('custom/img/celebration.png')); ?>" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300"/>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                    <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                        <h1 style="text-align:center; color: #000000; line-height:32px"><?php echo e(__('Your order is here')); ?>!</h1>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                    <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                        <p style="margin: 10px 0; text-align: center;"><?php echo e(__('Hi')); ?> <?php echo e($order->name); ?>,<?php echo e(__('Thank you for Shopping')); ?>.&nbsp;</p>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                        <tr>
                                            <td align="center" bgcolor="#DEDEDE" role="presentation" style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#DEDEDE;" valign="middle">
                                                <a href="<?php echo e($product_link); ?>" target="_blank" download style="background:#DEDEDE;color:#222222;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                    <b style="font-weight:700"><b style="font-weight:700"><?php echo e(__('Your Order')); ?></b></b>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
...
<?php /**PATH /home/store/public_html/resources/views/emails/productMail.blade.php ENDPATH**/ ?>
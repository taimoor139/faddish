                                                            ...
                                                            <div class="row align-items-center">
                                                                <div class="col ml-n2">
                                                                    <p class="card-text small text-muted">
                                                                            ...
                                                                            <img class="rounded"
                                                                                src="<?php echo e($p_logo.(isset($file->product_images) && !empty($file->product_images)?$file->product_images:'is_cover_image.png')); ?>"
                                                                ...
                                                                <div class="col-auto actions">
                                                                        ...
                                                                        <a class="action-item" href="<?php echo e($p_logo.(isset($file->product_images) && !empty($file->product_images)? $file->product_images :'favicon.png')); ?>" download="" data-toggle="tooltip"
                                                                        data-original-title="<?php echo e(__('Download')); ?>" target="_blank">
                                                ...
                                                <div class="px-3 py-3">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto actions">
                                                                ...
                                                                <a class="action-item" href="<?php echo e($logo.(isset($product->is_cover) && !empty($product->is_cover)? $product->is_cover :'favicon.png')); ?>" download="" data-toggle="tooltip"
                                                                    data-original-title="<?php echo e(__('Download')); ?>" target="_blank">
                                                                <i class="fas fa-download"></i>
                                                            </a>
                                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/faddishbuilder/public_html/storemanager.faddishbuilder.com/resources/views/product/edit.blade.php ENDPATH**/ ?>
    ...
    <div class="row">
        <div class="card p-0">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="float-right mb-0"><?php echo e(__('Last 7 Days')); ?></span>
            </div>
            <div class="card-body">
            ...
            <div class="row">
                <div class="col-xxl-6">
                    <div class="card ">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <span class="float-right"><?php echo e(__('Top') . ' 5 ' . __('URL')); ?></span>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="pie-store-dashborad"></div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-6">
                    ...
                    <div class="card bro-card">
                        ...
                        <div class="card-body">
                            <div id="pie-store-dashborad-1"></div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        var chart = new ApexCharts(document.querySelector("#pie-store-dashborad"), options);
        chart.render();
    </script>
    ...
    <script>
        ...
        var chart = new ApexCharts(document.querySelector("#pie-store-dashborad-1"), options);
        chart.render();
    </script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/faddishbuilder/public_html/storemanager.faddishbuilder.com/resources/views/store-analytic.blade.php ENDPATH**/ ?>
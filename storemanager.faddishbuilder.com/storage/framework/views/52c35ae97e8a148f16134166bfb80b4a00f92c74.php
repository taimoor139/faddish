                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php if(!empty($products->is_cover)): ?>
                                <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/is_cover_image/'.$products->is_cover))); ?>" class="img-fluid rounded prd_img_lg">
                            <?php else: ?>
                                <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/is_cover_image/default.jpg'))); ?>" class="img-fluid rounded prd_img_lg">
                            <?php endif; ?>
                            <div class="row mt-4">
                                    ...
                                    <div class="col-4">
                                        <div class="p-3 border rounded">
                                            <?php if(!empty($products_image[$key]->product_images)): ?>
                                                <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/product_image/'.$products_image[$key]->product_images))); ?>" class="img-fluid prd_img_sm">
                                            <?php else: ?>
                                                <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/product_image/default.jpg'))); ?>" class="img-fluid prd_img_sm">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/store/public_html/resources/views/storefront/view.blade.php ENDPATH**/ ?>